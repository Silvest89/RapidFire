...
struct RenderSystem : public entityx::System<RenderSystem> {
	void update(entityx::EntityManager &es, entityx::EventManager &events, entityx::TimeDelta dt) override {
		es.each<SkeletonComponent, CreatureComponent, PhysicsBodyComponent>([dt](entityx::Entity entity, SkeletonComponent &skeletonCP, CreatureComponent &creature, PhysicsBodyComponent &physicsBody) {
